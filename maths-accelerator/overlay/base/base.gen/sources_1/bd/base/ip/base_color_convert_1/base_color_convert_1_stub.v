...
//               base_color_convert_1_ base_color_convert_1_stub.v
...
(* CHECK_LICENSE_TYPE = "base_color_convert_1,color_convert,{}" *) (* CORE_GENERATION_INFO = "base_color_convert_1,color_convert,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=color_convert,x_ipVersion=1.0,x_ipCoreRevision=2114091749,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=7,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "color_convert,Vivado 2024.2" *) (* hls_module = "yes" *) 
