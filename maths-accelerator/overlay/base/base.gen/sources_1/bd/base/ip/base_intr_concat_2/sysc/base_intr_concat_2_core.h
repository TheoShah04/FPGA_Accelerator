...
#ifndef _base_intr_concat_2_core_h_
#define _base_intr_concat_2_core_h_
...
class base_intr_concat_2_core : public sc_module 
{
    public: 
       base_intr_concat_2_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(base_intr_concat_2_core);
    ...
    virtual ~base_intr_concat_2_core() = default;
