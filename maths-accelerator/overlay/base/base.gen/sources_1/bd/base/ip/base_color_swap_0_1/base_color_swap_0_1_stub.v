...
//               c:/LUTsofLUV/maths-accelerator/overlay/base/base.gen/sources_1/bd/base/ip/base_color_swap_0_1/base_color_swap_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "base_color_swap_0_1,color_swap,{}" *) (* CORE_GENERATION_INFO = "base_color_swap_0_1,color_swap,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=color_swap,x_ipVersion=1.1,x_ipCoreRevision=3,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,input_format=rgb,output_format=rbg}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
