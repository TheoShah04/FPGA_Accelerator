...
HD_PWD='C:/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_ps7_0_axi_periph_imp_auto_pc_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_ps7_0_axi_periph_imp_auto_pc_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_ps7_0_axi_periph_imp_auto_pc_6.tcl
