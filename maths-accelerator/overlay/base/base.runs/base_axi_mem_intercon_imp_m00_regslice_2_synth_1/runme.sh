...
HD_PWD='C:/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_axi_mem_intercon_imp_m00_regslice_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_mem_intercon_imp_m00_regslice_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_mem_intercon_imp_m00_regslice_2.tcl
