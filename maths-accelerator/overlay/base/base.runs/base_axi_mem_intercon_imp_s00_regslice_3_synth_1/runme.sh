...
HD_PWD='C:/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_axi_mem_intercon_imp_s00_regslice_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_mem_intercon_imp_s00_regslice_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_mem_intercon_imp_s00_regslice_3.tcl
