...
HD_PWD='C:/Users/Leeung/Projects/LUTsofLUV/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_m02_regslice_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m02_regslice_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m02_regslice_6.tcl
