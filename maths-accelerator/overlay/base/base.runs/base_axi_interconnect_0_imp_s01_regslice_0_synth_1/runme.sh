...
HD_PWD='C:/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_axi_interconnect_0_imp_s01_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_interconnect_0_imp_s01_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_interconnect_0_imp_s01_regslice_0.tcl
