...
HD_PWD='C:/Users/Leeung/Projects/LUTsofLUV/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_m16_regslice_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m16_regslice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m16_regslice_0.tcl
