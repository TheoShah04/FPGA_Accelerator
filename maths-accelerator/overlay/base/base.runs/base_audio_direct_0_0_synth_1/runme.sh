...
HD_PWD='C:/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_audio_direct_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_audio_direct_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_audio_direct_0_0.tcl
