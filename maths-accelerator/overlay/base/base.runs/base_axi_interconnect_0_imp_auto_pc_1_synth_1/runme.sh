...
HD_PWD='C:/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_axi_interconnect_0_imp_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_interconnect_0_imp_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_interconnect_0_imp_auto_pc_1.tcl
