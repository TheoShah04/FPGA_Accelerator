...
HD_PWD='C:/Users/Leeung/Projects/LUTsofLUV/LUTsofLUV/maths-accelerator/overlay/base/base.runs/base_m05_regslice_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m05_regslice_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m05_regslice_5.tcl
